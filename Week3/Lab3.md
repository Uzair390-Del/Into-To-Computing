...
| --- | --- | --- |
| **Bullet points** | Unordered lists (no specific sequence matters) | • Item A • Item B |
| **Numbered lists** | Ordered/sequential steps or ranked items | 1. Step one 2. Step two |
...
✅ **Word processors** (MS Word, Google Docs) are used to create formatted text documents ✅ Common business documents: **letters, memos, resumes** — each with its own standard structure ✅ Formatting tools: **headings, bullets, numbering, indentation** help organize content clearly ✅ **Page setup** controls margins/orientation; **headers/footers** repeat content on every page ✅ **Tables** organize data into rows & columns; **images** make documents visual and engaging
